...
namespace PlaylistDownloaderAng.Function
{
    public class Export
    {
        ...
        public Export(ILoggerFactory loggerFactory)
        {
        ...
        {
            JsonObject playlist = await JsonSerializer.DeserializeAsync<JsonObject>(req.Body);
            ...
            string[] SheetHeaders = new string[6]; ;// ["Title", "Artist", "Album", "Time", "Date Added", "URL"];
            SheetHeaders[0] = "Title";
            SheetHeaders[1] = "Artist";
            SheetHeaders[2] = "Album";
            SheetHeaders[3] = "Time";
            SheetHeaders[4] = "Date Added";
            SheetHeaders[5] = "URL";
